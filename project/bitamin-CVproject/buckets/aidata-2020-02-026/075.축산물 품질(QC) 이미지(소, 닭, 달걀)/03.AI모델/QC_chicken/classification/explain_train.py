...
class Prediction:
    def __init__(self, total_recon_loss, true_label_tot, test=False, best_f1_threshold=None):
    ...
    def get_prediction(self):
        ...
        if not self.test:
            ...
            # Final result        
            f1=self.cal_for_curve(self.best_f1_threshold)

            return self.true_label_tot, self.pred_label_tot, f1, self.best_f1_threshold
        
        else:
            f1=self.cal_for_curve(self.best_f1_threshold)
            return f1, self.best_f1_threshold
